    ...
    try{
        ...
        if(query.data === 'offer info' && state.telegram){
            ...
            await bot.sendPhoto(telegramId, qrCodeBuffer, { caption: `QR-код для подключения по вашей подписке./n/n
                ...
                За каждого приглашенного друга, вы получаете скидку <b>${apiServerConfig.invite_discount}%</b> на следующую оплату, друг — <b>${apiServerConfig.for_invited_discount}%</b>. 
