        ...
        if(query.data === 'offer info' && state.telegram){
            ...
            await bot.sendPhoto(telegramId, qrCodeBuffer, { caption: `QR-код для подключения по вашей подписке./n/n
                ...
                ${
                    ...
                    🔥 Скидка на следующий месяц: <b>${offerInfo.nextPayDiscount}%</b>/n/n
                    `
                }
                За каждого приглашенного друга, вы получаете скидку ${apiServerConfig.invite_discount}% на следующую оплату, друг — <b>${apiServerConfig.for_invited_discount}%</b>./n/n 
